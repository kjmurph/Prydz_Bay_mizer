...
```{r}
# Load total carbon data for picoplankton and reformat dataframe
GFDL_pico_raw <- read.csv("gfdl-mom6-cobalt2_obsclim_phypico-vint_15arcmin_prydz-bay_monthly_1961_2010.csv") 
...
```{r}
GFDL_diat_raw <- read.csv("gfdl-mom6-cobalt2_obsclim_phydiat-vint_15arcmin_prydz-bay_monthly_1961_2010.csv") 
dim(GFDL_diat_raw)
head(GFDL_diat_raw)
```
...
```{r}
GFDL_diaz_raw <- read.csv("gfdl-mom6-cobalt2_obsclim_phydiaz-vint_15arcmin_prydz-bay_monthly_1961_2010.csv") 
dim(GFDL_diaz_raw)
head(GFDL_diaz_raw)
```
...
```{r}
GFDL_zmicro_raw <- read.csv("gfdl-mom6-cobalt2_obsclim_zmicro-vint_15arcmin_prydz-bay_monthly_1961_2010.csv") 
dim(GFDL_zmicro_raw)
...
```{r}
GFDL_zmeso_raw <- read.csv("gfdl-mom6-cobalt2_obsclim_zmeso-vint_15arcmin_prydz-bay_monthly_1961_2010.csv")
dim(GFDL_zmeso_raw)
head(GFDL_zmeso_raw)
```
...
so_params <- readRDS("base_params.rds")
