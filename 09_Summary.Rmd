...
if (exists("enhanced_sims") && length(enhanced_sims) > 0) {
  ...
  create_faceted_yield_plot <- function(sim_list, observed_data = NULL, baseline_sim = NULL) {
    ...
    # Extract yield data from all LHS simulations
    sim_yields <- lapply(1:length(sim_list), function(i) {
    ...
    sim_yields <- sim_yields[!sapply(sim_yields, is.null)]
  ...
  create_faceted_biomass_plot <- function(sim_list, obs_biomass_data = NULL, baseline_sim = NULL) {
    ...
    # Extract biomass data from all simulations
    sim_biomass_list <- lapply(1:length(sim_list), function(i) {
    ...
    # Remove NULL results and combine
    sim_biomass_list <- sim_biomass_list[!sapply(sim_biomass_list, is.null)]
