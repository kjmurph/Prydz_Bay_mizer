...
p_yield_optimal_v2 <- ggplot() +
  ...
  labs(
    ...
    subtitle = "Gray dashed = baseline model, Colored solid = optimal fit, Blue ribbon = 95% CI",
    x = "Year",
    y = "Yield"
  )
...
p_biomass_optimal_v2 <- ggplot() +
  ...
  labs(
    ...
    subtitle = "Gray dashed = baseline model, Colored solid = optimal fit, Green ribbon = 95% CI",
    x = "Year",
    y = "Biomass"
  )
