...
if (exists("enhanced_sims") && length(enhanced_sims) > 0) {
  ...
  cat("Creating enhanced uncertainty plots with", length(enhanced_sims), "LHS simulations...\n")
  ...
  if (exists("plot_yield_uncertainty")) {
    p_yield_enhanced <- plot_yield_uncertainty(
      ...
      title = "LHS Enhanced Yield Projections with Uncertainty"
    )
    print(p_yield_enhanced)
  } else {
    cat("plot_yield_uncertainty function not available\n")
  }
  ...
  if (exists("plot_biomass_uncertainty")) {
    p_biomass_enhanced <- plot_biomass_uncertainty(
      enhanced_sims,
      title = "LHS Enhanced Biomass Projections with Uncertainty"
    )
    print(p_biomass_enhanced)
  } else {
    cat("plot_biomass_uncertainty function not available\n")
  }
  
  # Save plots if they were created
  if (exists("p_yield_enhanced")) {
    ggsave("enhanced_yield_uncertainty_lhs.png", p_yield_enhanced, width = 12, height = 8, dpi = 300)
  }
  if (exists("p_biomass_enhanced")) {
    ggsave("enhanced_biomass_uncertainty_lhs.png", p_biomass_enhanced, width = 12, height = 8, dpi = 300)
  }
  
  cat("✓ Enhanced uncertainty plots created and saved\n")
  cat("✓ Plots show 50% (dark ribbons) and 90% (light ribbons) confidence intervals\n")
  cat("✓ LHS sampling provides better parameter space coverage than Monte Carlo\n")
