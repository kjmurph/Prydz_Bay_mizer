...
if (validation_test$success_rate >= 80) {
  ...
  # For comparison, also run a smaller Monte Carlo version (optional)
  cat("\nStep 2b: Running smaller Monte Carlo comparison (500 sims)...\n")
  ...
  # Save both LHS and MC results
  saveRDS(lhs_uncertainty_results, "lhs_uncertainty_final_results.RDS")
  saveRDS(mc_uncertainty_results, "mc_uncertainty_comparison_results.RDS")
  
  # Compare LHS vs Monte Carlo performance
  cat("\nStep 3: Comparing LHS vs Monte Carlo approaches...\n")
  ...
  lhs_success_rate <- lhs_uncertainty_results$success_rate
  mc_success_rate <- (mc_uncertainty_results$n_successful / mc_uncertainty_results$n_attempts) * 100
  
  cat("\n=== FINAL LHS vs MONTE CARLO COMPARISON ===\n")
  cat("LHS Results (", lhs_uncertainty_results$n_requested, "simulations):\n")
  cat("  Success rate:", round(lhs_success_rate, 1), "%\n")
  cat("  Successful simulations:", lhs_uncertainty_results$n_successful, "\n")
  ...
  # Use LHS results as primary for further analysis
