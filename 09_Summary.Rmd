...
if (validation_test$success_rate >= 80) {
  ...
  lhs_uncertainty_results <- run_lhs_enhanced_uncertainty_sims(
    ...
    n_sims = 3000,  # Full simulation set with LHS
    catchability_sd = 0.4,  # SD=0.4 gives ~49% CV for log-normal
    abundance_sd = 0.8,     # SD=0.8 gives ~122% CV for log-normal  
    gamma_sd = 0.4,         # SD=0.4 gives ~49% CV for gamma (search rate)
    marine_mammal_species = c("minke whales", "orca", "sperm whales", "baleen whales"),
