...
create_biomass_plot_like_example <- function(sim_list, obs_biomass_data = NULL, n_test = NULL) {
  ...
  if (is.null(obs_biomass_data)) {
    ...
    # Handle provided observed biomass data
    cat("Adding provided observed biomass data...\n")
...
if (file.exists("enhanced_sims_test.RDS")) {
  ...
  test_yield_plot <- create_yield_plot_like_example(enhanced_sims_test, observed_yield, n_test = 5)
