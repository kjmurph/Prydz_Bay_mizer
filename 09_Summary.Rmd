...
run_lhs_enhanced_uncertainty_sims <- function(params,
  ...
  if (run_sensitivity_analysis && length(sim_results) >= 10) {
    cat("\n=== RUNNING SENSITIVITY ANALYSIS ===\n")
    sensitivity_results <- run_comprehensive_sensitivity_analysis(sim_results, lhs_params, marine_mammal_species)
