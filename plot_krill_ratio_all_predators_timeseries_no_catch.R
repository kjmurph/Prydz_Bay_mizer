...
# Save
###############################################################################
png_path <- file.path(OUTPUT_DIR, "krill_ratio_all_predators_timeseries_no_catch.png")
pdf_path <- file.path(OUTPUT_DIR, "krill_ratio_all_predators_timeseries_no_catch.pdf")
