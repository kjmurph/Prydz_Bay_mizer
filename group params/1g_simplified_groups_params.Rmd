---
title: "1g_simplified_groups_params_KJM.R"
output: html_notebook
---

Latest update - splitting up the euphausiid group into antarctic krill and other krill.
This way I'll have a direct comparison with KrillPODYM

Also, introduce salps from the start
...
```{r}
# sol_properties()
# x <- tibble(TL = c(0.7, 50), species = "Euphausia superba")
# x
...
zsp <- read_xlsx("C:/Users/kjmurphy/OneDrive - University of Tasmania/Documents/R Projects/Prydz_Bay_mizer/excel data/zoop_parameters_v2.xlsx", sheet="zoop simple groups", skip = 2)
zsp

df_z <- zsp %>% 
  filter(group == "antarctic krill"|group == "other krill"|group == "salps"|group == "mesozooplankton"|group == "other macrozooplankton") %>% 
...
```{r}
fish_params_wide <- readRDS("C:/Users/kjmurphy/OneDrive - University of Tasmania/Documents/R Projects/Prydz_Bay_mizer/fish_params_wide.RDS")
...
s.prm.w<- readRDS("C:/Users/kjmurphy/OneDrive - University of Tasmania/Documents/R Projects/Prydz_Bay_mizer/squid_params_wide.RDS")
...
p.if <- read_excel("C:/Users/kjmurphy/OneDrive - University of Tasmania/Documents/R Projects/Prydz_Bay_mizer/excel data/predator_parameter_collating_v1.xlsx", sheet="interaction_factors")
...
p.prm.w <- readRDS("C:/Users/kjmurphy/OneDrive - University of Tasmania/Documents/R Projects/Prydz_Bay_mizer/predator_params_wide.RDS")
# p.names <- read_csv("./csvs/predator_group_names.csv")
p.names <- read_csv("C:/Users/kjmurphy/OneDrive - University of Tasmania/Documents/R Projects/Prydz_Bay_mizer/csvs/predator_group_names_catch_calibration.csv")
...
Crabeater Seals	medium divers: a = 0.0019 cm SL   b = 3.3789   Ref. 120859
Antarctic Fur Seals	medium divers: a = 0.0039 cm BL b = 3.0000   Ref. 3742
Weddell Seals	medium divers: a = 0.2023 cm BL   b = 2.5300   Ref. 3730
...
# # intake rates
pQB <- read_excel("C:/Users/kjmurphy/OneDrive - University of Tasmania/Documents/R Projects/Prydz_Bay_mizer/excel data/predator_parameter_collating_v1.xlsx", sheet="QBs")
...
```{r}
biomass_observed <- c(4, # antarctic krill
                      1.9, # other krill
                      0.652, # salps
                      8.8, # other mesozooplankton
                      10, # macrozooplankton
                      0.127, # baleen whales
                      0.003, # flying birds
                      0.011, # large divers
...
```{r}
# write.csv(all.prm.tidy.ordered, "trait_groups_params_vCWC_v4.csv") #version Commercial Whaling Calibration
# write_rds(all.prm.tidy.ordered, "trait_groups_params_vCWC_v4.RDS")

# all.prm.tidy.ordered <- readRDS("trait_groups_params_vCWC_v3.RDS")
```

```{r}
# all.prm %>% saveRDS("all_groups_params_distributions.rds")
# all.prm.tidy.ordered %>% saveRDS("trait_groups_params_distributions_vCWC_v4.rds")
```
