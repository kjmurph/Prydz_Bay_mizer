...
png_out <- guard(file.path(FIGS, "fig1_mmwgeo_mti_linear_map_rebuilt167_no_ribbon_1929extent_zero_buffer_final_2.png"))
pdf_out <- guard(file.path(FIGS, "fig1_mmwgeo_mti_linear_map_rebuilt167_no_ribbon_1929extent_zero_buffer_final_2.pdf"))
csv_out <- guard(file.path(DATA, "fig1_mmwgeo_mti_linear_map_series_rebuilt167_no_ribbon_1929extent_zero_buffer_final_2.csv"))
