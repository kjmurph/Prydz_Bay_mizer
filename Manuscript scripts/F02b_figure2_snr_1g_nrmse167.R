...
SUPP <- file.path(FIGS, "Supplemental figures")
FIGS <- SUPP   # variant: the main-window figure goes to the supplement too
dir.create(SUPP, recursive = TRUE, showWarnings = FALSE)
SUF <- "1g_nrmse167"
REF_SUF <- "nrmse167"              # the full-range build, for the comparison print
