...
- **Approach**: Apply log-normal variation (±120% CV) to ALL 19 species, not just marine mammals
...
- **Approach**: Vary fishing catchability with ±60% CV around baseline estimates
- **Rationale**: Lower historical catchability could explain how some whale populations avoided complete depletion
...
- **Approach**: Vary gamma (search rate) parameters with ±70% CV for all species
- **Rationale**: Enhanced foraging efficiency could enable faster population recovery post-exploitation
