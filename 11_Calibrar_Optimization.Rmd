...
gamma_bounds <- data.frame(
  ...
  lower = log(species_params_df$gamma[species_params_df$species %in% fished_species] * 0.1),
  upper = log(species_params_df$gamma[species_params_df$species %in% fished_species] * 10),
  initial = log(species_params_df$gamma[species_params_df$species %in% fished_species])
)
