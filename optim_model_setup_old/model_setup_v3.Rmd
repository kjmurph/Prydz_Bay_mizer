...
groups_zoo <- read.csv("group params/trait_groups_params_vCWC_v2.csv")[,-1]
groups_raw <- read.csv("group params/trait_groups_params_vCWC_v3.csv")[,-1]
groups_zoo
groups_raw
```
...
```{r}
groups_raw$beta[1] # other krill
groups_raw$beta[2] # antarctic krill
groups_raw$beta[3] # salps
groups_raw$beta[4] # meso fish 
groups_raw$beta[5] # bathy fish
